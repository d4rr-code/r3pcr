...
urlpatterns = [
    ...
    path('update-tracking/<int:shipment_id>/', views.update_tracking_fields, name='update_tracking_fields'),
    ...
    path('shipment/<int:shipment_id>/fan-assessment/', views.save_fan_assessment, name='save_fan_assessment'),
    path('shipment/<int:shipment_id>/upload-supporting/<str:stage>/', views.upload_supporting_document, name='upload_supporting_document'),
