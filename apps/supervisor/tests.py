...
class SupervisorIntelligenceTests(TestCase):
    ...
    def test_intelligence_forecasts_workload_from_recent_incoming_trend(self):
        ...
        self.assertEqual(len(forecast['chart']['labels']), 15)
        self.assertEqual(len(forecast['chart']['historical_values']), 15)
        self.assertEqual(len(forecast['chart']['forecast_values']), 15)
        self.assertEqual(forecast['chart']['historical_values'][-3:], [None, None, None])
        self.assertEqual(len(forecast['period_rows']), 15)
